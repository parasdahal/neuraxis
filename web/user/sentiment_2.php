...
$isLoggedIn=$user->isLoggedIn();
  ...
  if(isset($_POST['reviewCol'])&&isset($_POST['labelCol']))
    { 
      $reviewCol= $_POST['reviewCol'];
      $labelCol=$_POST['labelCol'];
      $ins_name=$_SESSION['data']['instance'];
      
      $result=array("algorithm"=>$_SESSION['data']['algo'],"parameters"=>array("reviewCol"=>$reviewCol,"labelCol"=>$labelCol),"datasets"=>$_SESSION['data']['datasets'],"routes"=>$_SESSION['data']['route']);
