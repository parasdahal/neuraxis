...
$isLoggedIn=$user->isLoggedIn();
  ...
  if(isset($_POST['userCol'])&&isset($_POST['itemCol'])&&isset($_POST['ratingCol'])&&isset($_POST['itemId'])&&isset($_POST['title']))
    { 
      $ins_name=$_SESSION['data']['instance'];
      $usercol=$_POST['userCol'];
      $itemCol=$_POST['itemCol'];
      $ratingCol=$_POST['ratingCol'];
      $itemId=$_POST['itemId'];
      $title=$_POST['title'];

      $result=array("algorithm"=>$_SESSION['data']['algo'],"parameters"=>array("userCol"=>$usercol,"itemCol"=>$itemCol,"ratingCol"=>$ratingCol,"metaIdCol"=>$itemId,"metaTitleCol"=>$title),"datasets"=>$_SESSION['data']['datasets'],"routes"=>$_SESSION['data']['route']);
