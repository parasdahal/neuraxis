...
?>
    ...
    <div id="legend">
      <legend class="ctitle">Sentiment Classification Instance</legend>
      </div>
      <div class="col-sm-8">
        <br>
        <div class="message">
      ...
      if (isset($_GET['id']) and $_GET['id']==1) {
        ...
        <form class="form-horizontal" role="form" method="post" action="sentiment_1.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
            <label class="control-label col-sm-2" for="dataset_file">Dataset file (tsv)</label>
