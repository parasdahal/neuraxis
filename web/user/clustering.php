...
?>
    ...
    <div id="legend">
      ...
      if (isset($_GET['id']) and $_GET['id']==1) {
        ...
        <form class="form-horizontal" role="form" method="post" action="clustering_1.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
            <label class="control-label col-sm-2" for="k">K</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" id="regparam" name="k"  required="true">
    </div>
  </div>
