...
$isLoggedIn=$user->isLoggedIn();
  ...
  if(isset($_POST['labelCol']) and isset($_POST['feature']))
    { 
      $labelCol=$_POST['labelCol'];
      $feature=$_POST['feature'];
      $ins_name=$_SESSION['data']['instance'];

      $result=array("algorithm"=>$_SESSION['data']['algo'],"parameters"=>array("feature_col"=>$feature,"label_col"=>$labelCol,"regParam"=>$_SESSION['data']['regparam'],"alpha"=>$_SESSION['data']['alpha'],"num_iters"=>$_SESSION['data']['num_iters']),"datasets"=>$_SESSION['data']['datasets'],"routes"=>$_SESSION['data']['route']);
