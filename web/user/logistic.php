...
?>
    ...
    <div id="legend">
      ...
      if (isset($_GET['id']) and $_GET['id']==1) {
        ...
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong><span class="glyphicon glyphicon-info-sign"></span> Please choose a valid csv file !</strong></div> '; } 
          ?>

        </div>  
        <form class="form-horizontal" role="form" method="post" action="logistic_1.php" enctype="multipart/form-data">
    ...
    <div class="col-sm-10">
      <input type="number" step="0.01"class="form-control" id="alpha" name="alpha"  required="true">
    </div>
  </div>

      <div class="form-group">
            <label class="control-label col-sm-2" for="regparam">Number of Itterations</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" id="regparam" name="num_iters"  required="true">
    </div>
  </div>

    <div class="form-group">
            <label class="control-label col-sm-2" for="dataset_file">Dataset file (csv)</label>
...
<div class="form-group">
  ...
  <div class=sm-10>
    <div class="checkbox">
  <label><input type="checkbox" value="replace_missing_values" name=sanitizer[]>Replace Missing Values
    </label>
</div>
  <div class="checkbox">
