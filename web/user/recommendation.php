...
?>
    ...
    <div id="legend">
      <legend class="ctitle">Recommendation Instance</legend>
      </div>
      <div class="col-sm-8">
        <br>
        <div class="message">
      ...
      if (isset($_GET['id']) and $_GET['id']==1) {
        ...
        <form class="form-horizontal" role="form" method="post" action="recommendation_1.php" enctype="multipart/form-data">
    ...
    <div class="form-group">
            <label class="control-label col-sm-2" for="ratings_file">Ratings file (csv)</label>
    
    <div class="col-sm-10">
      <input type="file" name="ratings_file" required="true">
  </div>
</div>


    <div class="form-group">
            <label class="control-label col-sm-2" for="meta_file">Meta file (csv)</label>
    
    <div class="col-sm-10">
      <input type="file" name="meta_file" required="true">
  </div>
</div>
